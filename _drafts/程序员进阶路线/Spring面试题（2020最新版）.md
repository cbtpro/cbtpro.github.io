...
**Spring设计目标：**`Spring`为开发者提供一个一站式轻量级应用开发平台；
...
![Spring5的模块结构图](https://img-blog.csdnimg.cn/2019102923475419.png)
...
![BeanFactory和AplicationContext的关系](https://img-blog.csdnimg.cn/20191105111441363.png)
...
![Springbean的生命周期](https://img-blog.csdnimg.cn/201911012343410.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1RoaW5rV29u,size_16,color_FFFFFF,t_70)
...
![什么是切面Aspect](https://img-blog.csdnimg.cn/2020021212264438.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1RoaW5rV29u,size_16,color_FFFFFF,t_70)
