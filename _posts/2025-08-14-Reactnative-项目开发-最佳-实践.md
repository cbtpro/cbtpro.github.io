...
- 使用[react-native-boilerplate](https://link.juejin.cn?target=https%3A%2F%2Fthecodingmachine.github.io%2Freact-native-boilerplate%2Fdocs%2Finstallation)快速搭建脚手架- 接入图片上传组件[@baronha/react-native-multiple-image-picker](https://link.juejin.cn?target=https%3A%2F%2Fnitrogenzlab.github.io%2Freact-native-multiple-image-picker%2Fgetting-started)- 模拟器调试- 真机调试- 代码调试、网络调试- 发布 TestFlight- app图标更换- 启动页面设置
## 搭建脚手架
...
至于 ReactJS 的版本，0.78 支持 react 19，请参考[博客](https://link.juejin.cn?target=https%3A%2F%2Freactnative.dev%2Fblog%2F2025%2F02%2F19%2Freact-native-0.78)

Nodejs 版本官方要求是 18+，建议使用 LTS 版本，我使用的是 20，使用 nvm 管理版本。

使用 yarn 1.22 进行依赖安装。

![image.png](/assets/images/7538282563052634121-36.jpg)
...
建议使用[react-native-boilerplate](https://link.juejin.cn?target=https%3A%2F%2Fgithub.com%2Fthecodingmachine%2Freact-native-boilerplate)来创建工程，按照[官方文档](https://link.juejin.cn?target=https%3A%2F%2Fthecodingmachine.github.io%2Freact-native-boilerplate%2Fdocs%2Finstallation)来创建，大部分业务碰到的问题，它都涉及到了。
...
![image.png](/assets/images/7538282563052634121-35.jpg)
...
![image.png](/assets/images/7538282563052634121-34.jpg)
...
![image.png](/assets/images/7538282563052634121-33.jpg)
...
![image.png](/assets/images/7538282563052634121-32.jpg)
...
![添加模拟器版本 1.png](/assets/images/7538282563052634121-31.jpg)

![添加模拟器版本 2.png](/assets/images/7538282563052634121-30.jpg)

![添加模拟器版本 3.png](/assets/images/7538282563052634121-29.jpg)

![添加模拟器版本 4.png](/assets/images/7538282563052634121-28.jpg)

### 显示模拟器

但添加了模拟器，xcode 中并没有显示我需要的手机和系统版本，需要手动设置一下模拟器使用显示。

![在 XCode 中显示模拟器 1.png](/assets/images/7538282563052634121-27.jpg)

![在 XCode 中显示模拟器 2.png](/assets/images/7538282563052634121-26.jpg)
...
![image.png](/assets/images/7538282563052634121-25.jpg)

![image.png](/assets/images/7538282563052634121-24.jpg)

![image.png](/assets/images/7538282563052634121-23.jpg)
...
![image.png](/assets/images/7538282563052634121-22.jpg)

![image.png](/assets/images/7538282563052634121-21.jpg)

![image.png](/assets/images/7538282563052634121-20.jpg)

这时候项目基本成型，记得使用 git 将代码提交上去，后续的操作都基于这套代码上镜像。

## 技术选型

所有的 RN 第三方组件都在 [ReactNative目录](https://link.juejin.cn?target=https%3A%2F%2Freactnative.directory%2F)中搜索，根据更新时间、维护热度、使用热度和功能来选择，这里要关键词`image`搜索。
...
按照[官方文档](https://link.juejin.cn?target=https%3A%2F%2Fnitrogenzlab.github.io%2Freact-native-multiple-image-picker%2Fgetting-started)安装依赖
...
![image.png](/assets/images/7538282563052634121-19.jpg)
...
![image.png](/assets/images/7538282563052634121-18.jpg)

这里除了快捷键，可以通过1、2 来进行编译，可以通过 3、4 来清楚编译。

可以点击错误信息查看具体日志

![image.png](/assets/images/7538282563052634121-17.jpg)
...
![image.png](/assets/images/7538282563052634121-16.jpg)

参考链接[github.com/onevcat/Kin…](https://link.juejin.cn?target=https%3A%2F%2Fgithub.com%2Fonevcat%2FKingfisher%2Fissues%2F2379)
...
![image.png](/assets/images/7538282563052634121-15.jpg)

修改完成后，还需要再次执行`yarn pod-install`是 Podfile 应用生效。

再次执行`yarn ios`来尝试启动项目。ios可以正常获取权限和加载图片了。

![image.png](/assets/images/7538282563052634121-14.jpg)

再次尝试`yarn android`来启动安卓项目。

![image.png](/assets/images/7538282563052634121-13.jpg)

此时安卓和 ios 虚拟机都安装了 app，可以关掉 metro 的终端，单独使用`yarn start`启动react-native 开发，当修改 react 代码时，安卓和 ios 虚拟机可以同时更新，同时开发调试安卓和 IOS 了。

## 项目脚手架介绍

[react-native-boilerplate](https://link.juejin.cn?target=https%3A%2F%2Fthecodingmachine.github.io%2Freact-native-boilerplate%2Fdocs%2Finstallation)是一个非常优秀的 ReactNative 脚手架，它归纳了常用商业项目的基础功能

- 环境变量- 路由- 国际化- 导航- 网络请求- 主题- 存储- 调试 [reactotron/](https://link.juejin.cn?target=https%3A%2F%2Fdocs.infinite.red%2Freactotron%2F)- 组件：图片资源加载、字体、骨架屏、错误处理、安全屏幕
![image.png](/assets/images/7538282563052634121-12.jpg)
...
![image.png](/assets/images/7538282563052634121-11.jpg)

图片修改，在图片修改界面将不同尺寸的图片拖对应的图片中。

![image.png](/assets/images/7538282563052634121-10.jpg)
...
![image.png](/assets/images/7538282563052634121-9.jpg)

### app图标更换

ios 替换 app 图标

![image.png](/assets/images/7538282563052634121-8.jpg)

安卓替换 app 图标

![image.png](/assets/images/7538282563052634121-7.jpg)
...
网络调试请使用(reactotron)[[docs.infinite.red/reactotron/…](https://link.juejin.cn?target=https%3A%2F%2Fdocs.infinite.red%2Freactotron%2F%255D%25EF%25BC%258C%25E5%258F%25AF%25E4%25BB%25A5%25E5%25BE%2588%25E6%2596%25B9%25E4%25BE%25BF%25E7%259A%2584%25E8%25B0%2583%25E8%25AF%2595%25E5%25AE%2589%25E5%258D%2593%25E5%2592%258C) ios 的网络请求、存储、状态、日志、在编辑器中打开。

安装软件后，需要在 metro 终端使用 R 刷新，底部可以切换监控的设备。

![image.png](/assets/images/7538282563052634121-6.jpg)
...
![image.png](/assets/images/7538282563052634121-5.jpg)
request.d.ts
...
![image.png](/assets/images/7538282563052634121-4.jpg)
...
![image.png](/assets/images/7538282563052634121-3.jpg)
...
![image.png](/assets/images/7538282563052634121-2.jpg)
request.d.ts
