...
输出：
![image.png](/assets/images/7439322505649946651-10.jpg)
...
![image.png](/assets/images/7439322505649946651-9.jpg)
...
- \033[ ：表示开始转义序列。-  ：文字样式（如粗体、下划线）。-  ：文字颜色。-  ：背景颜色。- m：结束样式设置。- \033[0m：重置样式。
#### 文字颜色代码

| 颜色 | 前景色代码 | 背景色代码 || --- | --- | --- || 黑色 | 30 | 40 || 红色 | 31 | 41 || 绿色 | 32 | 42 || 黄色 | 33 | 43 || 蓝色 | 34 | 44 || 品红 | 35 | 45 || 青色 | 36 | 46 || 白色 | 37 | 47 |
#### 文字样式代码

| 样式 | 代码 || --- | --- || 默认样式 | 0 || 粗体 | 1 || 下划线 | 4 || 闪烁 | 5 || 反显 | 7 || 隐藏 | 8 |
#### 示例：彩色文字输出
...
![image.png](/assets/images/7439322505649946651-8.jpg)
...
![image.png](/assets/images/7439322505649946651-7.jpg)
...
![image.png](/assets/images/7439322505649946651-6.jpg)
...
![闪烁红色文字.gif](/assets/images/7439322505649946651-5.jpg)
...
![录屏2024-11-20 21.38.50.gif](/assets/images/7439322505649946651-4.jpg)
...
![录屏2024-11-20 21.42.57.gif](/assets/images/7439322505649946651-3.jpg)
...
输出：
![image.png](/assets/images/7439322505649946651-2.jpg)

可以访问使用`man figlet`或者查看官网[www.figlet.org/examples.ht…](https://link.juejin.cn?target=http%3A%2F%2Fwww.figlet.org%2Fexamples.html) 查看更多细节，这里不展开了。

figlet 还是 node 版本的[www.npmjs.com/package/fig…](https://link.juejin.cn?target=https%3A%2F%2Fwww.npmjs.com%2Fpackage%2Ffiglet)
...
1. 兼容性：ANSI 转义序列在大多数现代终端（如 Linux 和 macOS）中都能正常工作，但某些终端可能不支持。2. 清除样式：始终在样式结束后使用 \033[0m 重置，否则后续输出可能继承样式。
### 使用实践
...
![image.png](/assets/images/7439322505649946651-1.jpg)
