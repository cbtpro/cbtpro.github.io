...
UNPKG 是一个基于 [npm](https://www.npmjs.com/) 的内容分发网络（CDN），可以让你通过 URL 快速加载 npm 包中的任意文件，适用于无需构建的前端项目或在线测试/演示。我们所有的依赖都从它这里请求。公司项目请不要使用，自己的学习项目可以使用。
...
![](/assets/images/7534386099230883878-1.jpg)

可以直接访问package.json查看`export`和`import`信息

![](/assets/images/7534386099230883878-2.jpg)
...
![](/assets/images/7534386099230883878-3.jpg)

![](/assets/images/7534386099230883878-4.jpg)

![](/assets/images/7534386099230883878-5.jpg)
...
1. 去 [npmjs.com](https://www.npmjs.com/) 搜索包名。2. 查看 package.json 信息3. 查看 dist/ 或 esm/ 目录下有哪些文件。4. 拼接完整的路径用于 UNPKG 访问。
## 更简单的方式： [ESM Run](https://esm.run/)
...
- [Babel REPL](https://www.babeljs.cn/repl#?browsers=defaults%2C%20not%20ie%2011%2C%20not%20ie_mob%2011&build=&builtIns=false&corejs=3.21&spec=false&loose=false&code_lz=MYewdgziA2CmB00QHMAUBGATAZgJRA&debug=false&forceAllTransforms=false&modules=false&shippedProposals=false&evaluate=false&fileSize=false&timeTravel=false&sourceType=module&lineWrap=true&presets=env%2Creact%2Cstage-2&prettier=false&targets=&version=7.28.2&externalPlugins=&assumptions=%7B%7D)

转换、调试 JavaScript 最新语法，查看编译结果（支持 React、TS 等插件）- [TypeScript Playground](https://www.typescriptlang.org/play/?#-jSCeNsMq-)
官方 TypeScript 调试工具，支持类型推导、错误提示、转译预览- [React Native Snack](https://snack.expo.dev/)
在线运行 React Native 示例，支持模拟器预览（需登录）- [StackBlitz](https://stackblitz.com/)
类似 VSCode 的在线 IDE，支持完整 Node/npm、支持 Vue/React/Vite/Angular，全功能项目开发和 import map- [CodeSandbox](https://codesandbox.io/)
强大的前端项目协作平台，支持 npm 安装、importmap、适合组件库演示、Vue/React 开发- [JSFiddle](https://jsfiddle.net/)
传统的 HTML/CSS/JS 编辑器，适合快速原型，不推荐现代模块化开发- [CodePen](https://codepen.io/)
前端 UI 演示平台，支持动画、样式调试，适合 CSS/HTML 视觉展示项目- [Svelte REPL](https://svelte.dev/repl)
Svelte 官方在线编辑器，支持组件预览、动态参数，适合学习 Svelte
## 参考文档

[unpkg.com/](https://unpkg.com/)
[developer.mozilla.org/zh-CN/docs/…](https://developer.mozilla.org/zh-CN/docs/Web/HTML/Reference/Elements/script/type/importmap)
