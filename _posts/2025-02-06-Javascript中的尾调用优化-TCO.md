...
![](/assets/images/7467913090786525234-2.jpg)
Nodejs 表现
...
[Safari 使用尾调用和尾调用优化的性能对比。](https://jsperf.app/fusoje/6)


- Crhome 未使用尾调用优化
[Chrome 使用尾调用和trampoline的性能对比](https://jsperf.app/cixibi/2)
![](/assets/images/7467913090786525234-5.jpg)
