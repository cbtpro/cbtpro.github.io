...
`npm` 在 v8.3+ 引入了 [`overrides`](https://link.juejin.cn?target=https%3A%2F%2Fdocs.npmjs.com%2Fcli%2Fv8%2Fconfiguring-npm%2Fpackage-json%23overrides) 功能，用法类似：
...
- [force-resolutions GitHub](https://link.juejin.cn?target=https%3A%2F%2Fgithub.com%2Frogeriochaves%2Fforce-resolutions)- [Yarn Resolutions 文档](https://link.juejin.cn?target=https%3A%2F%2Fclassic.yarnpkg.com%2Fen%2Fdocs%2Fselective-version-resolutions%2F)- [npm overrides 官方文档](https://link.juejin.cn?target=https%3A%2F%2Fdocs.npmjs.com%2Fcli%2Fv8%2Fconfiguring-npm%2Fpackage-json%23overrides)
## 最佳实践建议
...
![image.png](/assets/images/6af03dcf1fc2.jpg)

通过`search node_modules`插件发现依赖`@rolldown/pluginutils`下面没有js文件。

![image.png](/assets/images/86792b218dac.jpg)
[www.npmjs.com/package/@ro…](https://link.juejin.cn?target=https%3A%2F%2Fwww.npmjs.com%2Fpackage%2F%40rolldown%2Fpluginutils%2Fv%2F1.0.0-beta.8-commit.56abf23%3FactiveTab%3Dcode)

再访问npm上对应的的版本，发现在一天前npm有被publish一次，但是列表可以看到一个月前发布的。

![image.png](/assets/images/4b39ff491ca3.jpg)

列表没有取最新的时间，但详情页表示确实推送过，就是这次推送，导致了历史的版本内容消失，本地重新安装依赖后就报错。

![image.png](/assets/images/0aa10ca93f0b.jpg)

而最新的版本，也是昨天推送的，可以标记为弃用，但还是选择了直接重新推一个空的仓库，可能是作者故意为之，想将仓库里有重大问题的仓库代码直接删除。

[www.npmjs.com/package/@ro…](https://link.juejin.cn?target=https%3A%2F%2Fwww.npmjs.com%2Fpackage%2F%40rolldown%2Fpluginutils%2Fv%2F1.0.0-beta.18%3FactiveTab%3Dcode)

![image.png](/assets/images/d5778e49cfdd.jpg)
...
![image.png](/assets/images/3ffe7ea5c0a7.jpg)
