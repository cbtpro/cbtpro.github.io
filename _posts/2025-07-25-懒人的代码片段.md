...
翻译成js版本[Typescript 演练场](https://link.juejin.cn?target=https%3A%2F%2Fwww.typescriptlang.org%2Fplay%2F%3F%23code%2FFAMwrgdgxgLglgewgAhHCATAylATggGwIFECBTAWzIhgGcAKWs82BXAfgC5laZd0A5gEpkAb2DJkUJL2T4EMZAF4ezMq1zJ2yDAihgqNAHQBHMGVwBPLGo2NbMNiO679hmEYBGCDJYDcEshwIMj0AITyMCK4ZDBguCgA2gC6AYHSELIxtGAEdNyiyGru3KSU1DB%2ByAAWbHAAXkgwAIYE3N6EZM0QVQBuFvBQre0Ind3IAL4pysgpaZLg0PBIUtXqANYAgpgAKrjN-bhM9Myl5O4i4pKSGbK1-I00rTPMRrR4hAQA6nAYMNXIAB8RQIRigBDgFR%2Bf2qAWuUhkikOg2eKle73wRAAEmQ4AJqopga9wZCaDi8QT5tdgqF7g0ms8AD6M5DIuBDAiXQLw7K5OhGAAOYFo1XohWKFW4zAANDU6o8WgRZWyOZMhHDrhNgNzkAB6XXIQBICYAlfUAsgmAMOVAAragGFFQAEvjridU4AQMDEUAAyd3ITa4faWIwgfAUE6gqBOl1uoQBtjEZph%2Bhh50YZTAsMbbYYPYHCzHRMuoTqwJa9JrKBbXb7Q7HSKFyQxOIJORkHJ5WgBYv65CAf3lABSugE7TQCrNsBbooMZ8yu5aDM0JgcJiSOcKgx1XqDYBYOUABPKASATAJdGgAs1QAbeYAS6MAc3LIby%2BZCAAH1ANOawDHRAnS%2BjuFj8bFIPKNFldIVrWVAzss8EyyugGBkAAHiISjAlcCKZJ0RgEAgAj0AABnayAAMQACSiGBkHIAA1MgACMEycGhsoSjQtbwbQiHIahADkgBUVoAiCqAFt2gAVSoAhuacMxP7ygynIarcjEofQzGAK1%2BXF8QJAG4CionABM6pAA)

当然也可以用浏览器开发者工具的的Layers和Rendering选项卡，在页面上操作后，也能快速定位滚动区域。

![image.png](/assets/images/612a0981c0bc.jpg)

>> <p>适用场景：当开发者工具不能够定位到影响元素出现滚动的原因时。</p>>
## 高亮所有超出容器的元素（横向或纵向）
...
>> <p>适用场景：快速导出复杂数据结构给同事，便于复现和分析。</p>>
...
>> <p>排查元素错位、尺寸不对、隐藏溢出、margin collapse 等视觉问题。</p>>
>> <p>也可以把颜色调成 <code>rgba(0,255,0,0.2)</code> 代表可见元素，便于观察嵌套结构。</p>>
...
>> <p>适用场景：点击事件无效 / hover 无响应 / 模态层穿透。</p>> <p>配合 DevTools 中的 <code>$0</code>（当前选中元素）可以比对是否被盖住。</p>>
## 快速追踪 layout/layout shift（跳动）

定位页面跳动、卡片抖动等问题，利用浏览器的 [Layout Shift 调试工具](https://link.juejin.cn?target=https%3A%2F%2Fweb.dev%2Fcls%2F%23see-layout-shifts-in-devtools)。
