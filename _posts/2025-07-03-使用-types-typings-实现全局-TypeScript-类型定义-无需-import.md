...
vite在使用env的时候，可以参考vite的文档[cn.vite.dev/guide/env-a…](https://cn.vite.dev/guide/env-and-mode.html#env-files) ，它单独提供了一个`vite-env.d.ts`用来处理这种情况
...
本文仓库托管在[github.com/cbtpro/vite…](https://github.com/cbtpro/vite-vue3-ts-template)
